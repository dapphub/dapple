...
module.exports = class Workspace {
  ...
  addObject ( env, name, className, address ) {
    // console.log( env, name, className, address );
    if( !('environments' in this.dappfile) ) this.dappfile.environments = {};
    if( !(env in this.dappfile.environments) ) this.dappfile.environments[env] = {}
    if( !('objects' in this.dappfile.environments[env]) ) this.dappfile.environments[env].objects = {};
