...
module.exports = class Workspace {
    ...
    static writeDappleRC(path, data) {
        return DappleRC.writeSync(path, data);
    }
    ...
    getSourceDir() {
        return this.dappfile.layout.sol_sources;
    }
    ...
    getPackagesDir() {
        return this.dappfile.layout.packages_director || "dapple_packages";
    }
    ...
    getEnvironment() {
        return this.dappfile.environment;
    }
