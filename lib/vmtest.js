    ...
    if (message) {
      ...
      if (match) {
        ...
        if (error_class) {
          ...
          // TODO: not sure why opcodes usually comes out longer lol
          var length = Math.min(instructions.length, opcodes.length)

          for (var i = 0, pc = 0; i < length && pc < error_pc; i++, pc++) {
