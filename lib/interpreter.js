...
class Interpreter {
  ...
  export (key) {
    if (key in this.global) {
      this.log(`ERROR: ${key} is already declared in global environment!`);
      this.success = false;
    } else if (!(key in this.local)) {
      this.log(`ERROR: ${key} is not declared in local environment!`);
      this.success = false;
    } else {
  ...
  import (key) {
    if (key in this.local) {
      this.log(`ERROR: ${key} is already declared in local environment!`);
      this.success = false;
    } else if (!(key in this.importable)) {
      this.log(`ERROR: ${key} is not declared in dappfile environment!`);
      this.success = false;
    } else {
